...
export declare function createSuccessResponse(data: unknown): APIGatewayResponse;
export declare function createErrorResponse(statusCode: number, message: string): APIGatewayResponse;
