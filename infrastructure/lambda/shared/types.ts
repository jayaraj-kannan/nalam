...
export function createSuccessResponse(data: unknown): APIGatewayResponse {
  return {
    statusCode: 200,
    headers: {
...
export function createErrorResponse(statusCode: number, message: string): APIGatewayResponse {
  return {
    statusCode,
    headers: {
      'Content-Type': 'application/json',
